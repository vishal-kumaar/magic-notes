...
export default function UserProfile(props) {
  return (
    <div className={props.mode==="light" ? "bg-white" : "bg-gray-800"}>
      ...
      <div className="mt-10">
        <Link>
          <div className={`flex items-center justify-between shadow-md rounded-2xl px-2 py-1 mx-8 my-4 ${props.mode==="light" ? "text-gray-700 bg-gray-100" : "text-gray-300 bg-gray-700"}`}>

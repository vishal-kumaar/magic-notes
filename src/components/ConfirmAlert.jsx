    ...
    <>
      ...
      <div
        ...
        <div
          ...
          <h1 className="font-signika text-2xl mb-3">{props.title}</h1>
          <hr />
          <p className="text-base font-poppins mt-3 mb-14">{props.subtitle}</p>
          <div className="text-right">
            <button
              className="font-roboto border border-gray-400 text-base px-5 py-1 rounded-3xl"
              onClick={() => {
            ...
            <button
              className="bg-green-700 text-white font-roboto border border-green-700 text-base px-5 py-1 rounded-3xl ml-4"
              onClick={() => {
                props.setConfirmAlert(false);
